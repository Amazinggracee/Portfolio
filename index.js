...
const projectDetails = [
...

  {
    ...
    featuredImage: './Images/Img Placeholder3.png',
    technologies: ['html', 'bootstrap', 'ruby'],
    liveLink: 'See Live',
    sourceLink: 'See Source',
  },

  {
    ...
    featuredImage: './Images/Img Placeholder4.png',
    technologies: ['html', 'bootstrap', 'ruby'],
    liveLink: 'See Live',
    sourceLink: 'See Source',
  },

  {
    ...
    featuredImage: './Images/Img Placeholder5.png',
    technologies: ['html', 'bootstrap', 'ruby'],
    liveLink: 'See Live',
    sourceLink: 'See Source',
  },

  {
    ...
    featuredImage: './Images/Img Placeholder2.png',
    technologies: ['html', 'bootstrap', 'ruby'],
    liveLink: 'See Live',
    sourceLink: 'See Source',
  },
...
<div class="pop-win-header">
    ...
    <span class="pop-win-remove"><i class="fa-solid fa-xmark">X</i></span>
</div>
...
<img src="${projectDetails.featuredImage}" alt="" />
<div>
